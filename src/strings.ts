...
export const welcome: Dict = {
  title: () => 'Welcome to the <br/>Mirantis Container Cloud for Lens Extention',
  description: () => 'This extension enables you to connect to multiple Mirantis Container Cloud management clusters through Lens. You can now leverage Lens for basic lifecycle management operations such as:',
  listItems: () => `
  ...
  link: {
    label: () => 'And more!',
    href: () => 'https://github.com/Mirantis/lens-extension-cc/blob/master/README.md',
  },
  button: {
